	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?=base_url('admin/index')?>" class=""><i class="lnr lnr-file-add"></i> <span>Data Barang</span></a></li>
						<li><a href="<?=base_url('admin/nota')?>" class=""><i class="lnr lnr-list"></i> <span>Daftar Pesanan</span></a></li>
						<li><a href="<?=base_url('admin/data_pembeli')?>" class="active"><i class="lnr lnr-license"></i> <span>Data Pembeli</span></a></li>
						<!-- <li>
						...
						<div class="panel-body">
							<div class="row">
								<div class="table-users">
									<div class="headertable">Data Pembeli</div>
